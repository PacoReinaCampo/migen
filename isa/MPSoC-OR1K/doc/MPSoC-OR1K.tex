...
\subsection{1.1. HARDWARE}\label{hardware}

\subsection{1.2. SOFTWARE}\label{software}

\section{2. PROJECTS}\label{projects}

\subsection{2.1. RISC-V ARCHITECTURE}\label{risc-v-architecture}

\subsubsection{2.1.1. Library}\label{library}
...
\subsubsection{2.1.2. Toolchain}\label{toolchain}
...
\subsubsection{2.1.3. Software}\label{software-1}
...
\subsection{2.2. CORE-RISCV}\label{core-riscv}

\subsubsection{2.2.1. Definition}\label{definition}
...
\subsubsection{2.2.2. RISC Pipeline}\label{risc-pipeline}
...
\subsubsection{2.2.3. CORE-RISCV
...
\subsubsection{2.2.4. Parameters}\label{parameters}

\paragraph{2.2.4.1. Technology Parameters}\label{technology-parameters}
...
\subsubsection{2.2.5. Opcodes}\label{opcodes}

\paragraph{2.2.5.1. RV32I : Base Integer Instruction
...
\paragraph{2.2.5.2. RV64I : Base Integer Instruction Set
...
\paragraph{2.2.5.3. RV32M : Standard Extension for Integer Multiply and
...
\paragraph{2.2.5.4. RV64M : Standard Extension for Integer Multiply and
Divide
...
\paragraph{2.2.5.5. RV32A : Standard Extension for Atomic
...
\paragraph{2.2.5.6. RV64A : Standard Extension for Atomic Instructions
...
\paragraph{2.2.5.7. RV32F : Standard Extension for Single-Precision
...
\paragraph{2.2.5.8. RV64F : Standard Extension for Single-Precision
Floating-Point
...
\paragraph{2.2.5.9. RV32D : Standard Extension for Double-Precision
...
\paragraph{2.2.5.10. RV64D : Standard Extension for Double-Precision
Floating-Point
...
\subsubsection{2.2.6. Instruction Inputs/Outputs
...
\subsubsection{2.2.7. Data Inputs/Outputs
...
\subsection{2.3. PU-RISCV}\label{pu-riscv}

\subsubsection{2.3.1. Instruction Cache}\label{instruction-cache}
...
\paragraph{2.3.1.2. Instruction INPUTS/OUTPUTS AMBA4 AXI-Lite
Bus}\label{instruction-inputsoutputs-amba4-axi-lite-bus}

\subparagraph{2.3.1.2.1. Signals of the Read and Write Address
...
\subparagraph{2.3.1.2.2. Signals of the Read and Write Data
...
\subparagraph{2.3.1.2.3. Signals of the Write Response
...
\paragraph{2.3.1.3. Instruction INPUTS/OUTPUTS AMBA3 AHB-Lite
...
\paragraph{2.3.1.4. Instruction INPUTS/OUTPUTS Wishbone
...
\subsubsection{2.3.2. Data Cache}\label{data-cache}

\paragraph{2.3.2.1. Data Organization}\label{data-organization}
...
\paragraph{2.3.2.2. Data INPUTS/OUTPUTS AMBA4 AXI-Lite
Bus}\label{data-inputsoutputs-amba4-axi-lite-bus}

\subparagraph{2.3.2.2.1. Signals of the Read and Write Address
...
\subparagraph{2.3.2.2.2. Signals of the Read and Write Data
...
\subparagraph{2.3.2.2.3. Signals of the Write Response
...
\paragraph{2.3.2.3. Data INPUTS/OUTPUTS AMBA3 AHB-Lite
...
\paragraph{2.3.2.4. Data INPUTS/OUTPUTS Wishbone
...
\subsection{3.1. HARDWARE}\label{hardware-1}
...
\subsection{3.2. SOFTWARE}\label{software-2}

\subsubsection{3.2.1. Bare Metal}\label{bare-metal}
...
\subsubsection{3.2.2. Operating System}\label{operating-system}

\paragraph{3.2.2.1. GNU Linux}\label{gnu-linux}
...
\paragraph{3.2.2.2. GNU Hurd}\label{gnu-hurd}

\section{4. CONCLUSION}\label{conclusion}

\subsection{4.1. HARDWARE}\label{hardware-2}

\subsubsection{4.1.1. GSCL 45 nm ASIC}\label{gscl-45-nm-asic}

\subsubsection{4.1.2. Lattice iCE40 FPGA}\label{lattice-ice40-fpga}

\subsection{4.2. SOFTWARE}\label{software-3}

\subsubsection{4.2.1. Simulators}\label{simulators}

\paragraph{4.2.1.1. Spike (For Hardware
Engineers)}\label{spike-for-hardware-engineers}

\paragraph{4.2.1.2. QEMU (For Software
Engineers)}\label{qemu-for-software-engineers}

\subsubsection{4.2.2. Compilers}\label{compilers}

\paragraph{4.2.2.1. RISC-V GNU C/C++ / Go}\label{risc-v-gnu-cc-go}

\paragraph{4.2.2.2. RISC-V Binutils}\label{risc-v-binutils}
